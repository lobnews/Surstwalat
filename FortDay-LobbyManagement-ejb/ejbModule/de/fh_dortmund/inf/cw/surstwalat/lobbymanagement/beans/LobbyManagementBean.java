...
public class LobbyManagementBean implements LobbyManagementLocal
{
    ...
    /**
     * This method gets triggered if a user disconnects. It removes him from the lobby-users and every game he is in
     * currently.
     * 
     * @param userID
    ...
    /**
     * This method gets triggered if a user times out. It removes him from the lobby-users and every game he is in
     * currently.
     * 
     * @param userID
     *            ID of the user that timed out.
     */
    @Override
    ...
    /**
     * This method gets triggered if a creates a game. It creates a new game entity, initializes it and adds the creator
     * to it.
     * 
     * @param userID
     *            ID of the user that created a game.
     */
    @Override
    ...
    @Override
    public void userJoinsGame(int userID, int gameID)
     ...
     * 
     * @param gameId
     *            The ID of the games that has been started.
     * @param fieldsize
     *            The fieldsize of the gamefield in this game.
     */
     ...
     * 
     * @param userID
     *            ID of the user that created the game.
     * @param gameID
     ...
     * @param fieldsize
     *            The size of the field the gamehost chose.
     */
    @Override
    ...
    /**
     * This method returns a list of all users that are in the lobby (not in a game right now but logged in).
     * 
    ...
    /**
     * This method returns a list of all open games. Open games are games that are not started right now.
     * 
    ...
    /**
     * This method creates and initializes a new game. It also persists it to the db and get its id.
     * 
    ...
    /**
     * This method uses named queries to load a game with a given ID from the DB and return it.
     * 
     * @param gameid
    ...
    /**
     * This method uses name queries to load a user with a given id from the DB and return it.
     * 
     * @param userid
     *            The id of the user to be loaded.
    ...
    /**
     * This method is called if a user disconnects or times out for example. It removes him from all games he is in and
     * closes them if he was the last human player in this game and it didnt start yet.
     * 
     * @param userid
     *            The ID of the user to be removed from games.
     */
    ...
    /**
     * This method just runs a few simple tests to check general functionality while development. The test results need
     * to be checked manually. (no junit)
     */
