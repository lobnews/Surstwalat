...
@MessageDriven(activationConfig =
{
  ...
  @ActivationConfigProperty(
      ...
      propertyValue = PropertyType.MESSAGE_TYPE + " = " + MessageType.TOKEN_CREATED) //TODO: richtiger Type
...
public class TokenCreatedEventHandlerBean implements MessageListener
{
    ...
    public void onMessage(Message message)
    {
        ...
        {
            locationManagement
                .addTokenToPlayground(
                    message.getIntProperty(PropertyType.GAME_ID),
                    message.getIntProperty(PropertyType.PLAYER_ID),
